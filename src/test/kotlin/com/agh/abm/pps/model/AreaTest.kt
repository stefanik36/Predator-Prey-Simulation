...
class AreaTest {
    ...
    fun getOverview() {
        ...
        var area = Area(listOf(predator01, predator02, predator03, prey01, prey02, prey03))
        ...
        Assertions.assertEquals(
            "AREA [1]:\n" +
                    ...
                    "\tPREY [5.93;6.38]; energy[6.00],\n" +
                    "\tPREY [0.93;1.38]; energy[6.00],\n" +
                    "\tPREY [5.93;0.38]; energy[6.00]", result
        )
    }
